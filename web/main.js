...
function insertListItem(title, data, imageSrc) {
  ...
  //Currently I'm placing a default word image in the file item since there's currently
  //no way to retrieve file image
...
function codechange() {
  //This code is commented becausewe don't need to change the button text
  //nor its enabled property
...
async function init() {
  ...
  let wasmURL = "https://webwormhole.io/webwormhole.wasm";
  if (hacks.chromeext) {
